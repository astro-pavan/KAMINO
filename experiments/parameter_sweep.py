...
def _run_name(s, o, c, d, rw, mgsi, diw, alpha, kd_mg, k_na, pe=PE_DEFAULT_SWEEP, land=0.0):
    ...
    `land` is tagged against 0.0 -- the Planet default and what every sweep here runs at -- so an
    ocean world keeps the untagged name it already has on disk and a continental run
    (continental_baseline.py) can never collide with it.
    """
